...
<div class="container" ng-app="">
    <div ng-controller="initApp">
        <div class="row">
            ...
            <div class="col-md-6">
                <h4 class="text-center">Listagem de Supervisores</h4>
            </div>
            <div class="col-md-3">
        ...
        <table class="table table-striped table-hover">
            <tbody><tr>
                ...
                <th class="description" title="non-sortable">Matrícula</th>
                <th class="field3"><a ng-click="sort_by('field3')"> Telefone<i class="fa fa-sort"></i></a></th>
                <th class="field4"><a ng-click="sort_by('field4')">CPF <i class="fa fa-sort"></i></a></th>
                <th class="field5"><a ng-click="sort_by('field5')">Data de Nascimento <i class="fa fa-sort"></i></a></th>
                <th></th>
            </tr>
            </tbody>
            <tfoot>
            ...
            <%if(pesquisa == null || pesquisa == "" )
	            ...
	            <tr ng-repeat="item in pagedItems[currentPage] | orderBy:sortingOrder:reverse">
	                ...
	                <td><%out.println(i.getMatricula());%></td>
	                <td><%out.println(i.getTelefone());%></td>
	                <td><%out.println(i.getCpf());%></td>
	                <td><%out.println(i.getDataNascimento());%></td>
           ...
           <%{
            for(Supervisor i : SupervisorController.getInstance().buscarPorNome(pesquisa))
            	{%>
	            <tr ng-repeat="item in pagedItems[currentPage] | orderBy:sortingOrder:reverse">
	                <td><%out.println(i.getId());%></td>
	                <td><%out.println(i.getNome());%></td>
