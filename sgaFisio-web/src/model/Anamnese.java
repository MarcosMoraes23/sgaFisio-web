...
public class Anamnese implements Serializable 
{
    ...
    @Column(name = "id")
	@GeneratedValue(strategy=GenerationType.SEQUENCE, generator="sequence_anamnese")
	@SequenceGenerator(name="sequence_anamnese", sequenceName="sequence_anamnese", allocationSize=1)
    public Long getId() {
        return id;
    }
